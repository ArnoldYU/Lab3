...
<html>
  ...
  <body class="body1"> 
    <div class="center">
    	...
    	<form class="form-horizontal" action="AuthorRegistPro" method="post" role="submit" onsubmit="return regs('click')">
		  <div class="control-group">
		    <label class="control-label" for="inputEmail">AuthorID</label>
		    <div class="controls">
		      <input type="text"  placeholder="AuthorID" name="author.AuthorID" required/><span></span>
		    </div>
		  </div>
		  <div class="control-group">
